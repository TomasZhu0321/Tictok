...
const Comments = ({
  ...
  return (
    <div className="border-t-2 border-black pt-4 px-10 mt-4 bg-[#F8F8F8] border-b-2 lg:pb-0 pb-[100px]">
                    ...
                    <div className="p-2 items-center" key={idx}>
                      <Link href={`/profile/${user._id}`}>
                        <div className="flex items-start gap-3 ">
                          ...
                          <div className="hidden xl:block text-blue-400">
                            <GoVerified />
                          </div>
                        </div>
                      </Link>
                      <div>
                        <p className="-mt-2 ml-20 text-[16px] mr-8 mb-3">
                          {item.comment}
                        </p>
                      </div>
                    </div>
      ...
      {userProfile && (
        <div className="relative bottom-0 left-0 pb-6 px-2 md:px-10">
